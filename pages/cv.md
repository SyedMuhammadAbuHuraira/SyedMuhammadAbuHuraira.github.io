...
<div class="cv-section">
    ...
    <div class="cv-item">
        <div class="cv-item-date">2018-2023</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">University of Maryland, College Park</div>
                <div class="cv-item-position">PhD, Computer Science</div>
            </div>
    ...
    <div class="cv-item">
        <div class="cv-item-date">2015–2018</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">University of Maryland, College Park</div>
                <div class="cv-item-position">Bachelor of Science, Physics</div>
            </div>
            <div class="cv-item-description">
...
<div class="cv-section">
    ...
    <div class="cv-item">
        <div class="cv-item-date">1/2021–present</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">Farama Foundation</div>
                <div class="cv-item-position">Founder and CEO</div>
            </div>
            <div class="cv-item-description">
            ...
            <div class="cv-link">
                <div class="cv-link-label">Learn more: </div>
                <a href="https://farama.org" class="cv-link-button">
                    <div class="cv-link-text">farama.org</div>
                    <div class="cv-link-icon"></div>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="cv-item">
        <div class="cv-item-date">8/2020–9/2024</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">Swarm Labs</div>
                <div class="cv-item-position">Founder and CEO</div>
            </div>
            <div class="cv-item-description">
    ...
    <div class="cv-item">
        <div class="cv-item-date">1/2019–1/2023</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">QinetiQ North America</div>
    ...
    <div class="cv-item">
        <div class="cv-item-date">8/2018–5/2019</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">Recurrent Computing, Inc</div>
                <div class="cv-item-position">Machine Learning Engineer</div>
            </div>
            <div class="cv-item-description">
    ...
    <div class="cv-item">
        <div class="cv-item-date">8/2017–5/2019</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">University of Maryland</div>
                <div class="cv-item-position">Machine Learning Instructor</div>
            </div>
            <div class="cv-item-description">
    ...
    <div class="cv-item">
        <div class="cv-item-date">6/2017–5/2018</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">Redhorse Corporation</div>
                <div class="cv-item-position">Data Scientist</div>
            </div>
            <div class="cv-item-description">
    ...
    <div class="cv-item">
        <div class="cv-item-date">5/2016–8/2017</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">University of Maryland Center for Nanophysics and Advanced Materials</div>
                <div class="cv-item-position">Undergraduate Researcher</div>
            </div>
            <div class="cv-item-description">
    ...
    <div class="cv-item">
        <div class="cv-item-date">9/2014–8/2015</div>
        <div class="cv-item-content">
            <div class="cv-item-header">
                <div class="cv-item-company">University of Washington, Center for Experimental Nuclear Physics and Astrophysics</div>
                <div class="cv-item-position">Intern</div>
            </div>
            <div class="cv-item-description">
